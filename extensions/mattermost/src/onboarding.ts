import type { ChannelOnboardingAdapter, OmniClawConfig, WizardPrompter } from "omniclaw/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.omniclaw.ai/channels/mattermost",
    ].join("\n"),
