...
export function listMattermostAccountIds(cfg: OmniClawConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: OmniClawConfig): string {
...
export function listEnabledMattermostAccounts(cfg: OmniClawConfig): ResolvedMattermostAccount[] {
