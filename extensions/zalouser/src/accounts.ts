...
export function listZalouserAccountIds(cfg: OmniClawConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: OmniClawConfig): string {
...
function mergeZalouserAccountConfig(cfg: OmniClawConfig, accountId: string): ZalouserAccountConfig {
