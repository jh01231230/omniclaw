...
Nostr DM channel plugin for OmniClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to OmniClaw. It enables your bot to:
...
# Configure omniclaw to use local relay
