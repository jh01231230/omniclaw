...
function resolveAnthropicDefaultAuthMode(cfg: OmniClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: OmniClawConfig): OmniClawConfig {
...
export function applyTalkApiKey(config: OmniClawConfig): OmniClawConfig {
...
export function applyModelDefaults(cfg: OmniClawConfig): OmniClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: OmniClawConfig): OmniClawConfig {
...
export function applyLoggingDefaults(cfg: OmniClawConfig): OmniClawConfig {
...
export function applyContextPruningDefaults(cfg: OmniClawConfig): OmniClawConfig {
...
export function applyCompactionDefaults(cfg: OmniClawConfig): OmniClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
