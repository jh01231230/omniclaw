...
function resolveMentionPatterns(cfg: OmniClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: OmniClawConfig | undefined, agentId?: string): RegExp[] {
