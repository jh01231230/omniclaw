...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@omniclaw", { botUsername: "omniclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@omniclaw args", {
        botUsername: "omniclaw",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@omniclaw: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "omniclaw" })).toBe(
      "/help@otherbot",
    );
  });
