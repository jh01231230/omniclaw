...
describe("gateway server hooks", () => {
  test("handles auth, wake, and agent flows", async () => {
    ...
    try {
      ...
      const prevAllowQuery = process.env.OMNICLAW_HOOKS_ALLOW_QUERY_TOKEN;
      process.env.OMNICLAW_HOOKS_ALLOW_QUERY_TOKEN = "true";
      try {
        ...
        if (prevAllowQuery === undefined) {
          delete process.env.OMNICLAW_HOOKS_ALLOW_QUERY_TOKEN;
        } else {
          process.env.OMNICLAW_HOOKS_ALLOW_QUERY_TOKEN = prevAllowQuery;
        }
      }
