...
import type { OmniClawConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: OmniClawConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: OmniClawConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: OmniClawConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: OmniClawConfig) => void;
  log: {
