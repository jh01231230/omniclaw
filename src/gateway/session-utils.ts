...
import { type OmniClawConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: OmniClawConfig): string[] {
...
export function listAgentsForGateway(cfg: OmniClawConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OmniClawConfig): string {
...
function resolveSessionStoreAgentId(cfg: OmniClawConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: OmniClawConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: OmniClawConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: OmniClawConfig): GatewaySessionsDefaults {
