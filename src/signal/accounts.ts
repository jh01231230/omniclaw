...
export function listSignalAccountIds(cfg: OmniClawConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: OmniClawConfig): string {
...
function mergeSignalAccountConfig(cfg: OmniClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: OmniClawConfig): ResolvedSignalAccount[] {
