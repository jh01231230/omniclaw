...
export function listBindings(cfg: OmniClawConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: OmniClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: OmniClawConfig) {
