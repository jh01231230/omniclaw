...
const ensureOmniClawModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveOmniClawAgentDir = vi.fn().mockReturnValue("/tmp/omniclaw-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/omniclaw-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureOmniClawModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveOmniClawAgentDir,
}));
