...
export function applyZaiConfig(cfg: OmniClawConfig): OmniClawConfig {
...
export function applyOpenrouterProviderConfig(cfg: OmniClawConfig): OmniClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: OmniClawConfig): OmniClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: OmniClawConfig): OmniClawConfig {
...
export function applyOpenrouterConfig(cfg: OmniClawConfig): OmniClawConfig {
...
export function applyMoonshotProviderConfig(cfg: OmniClawConfig): OmniClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: OmniClawConfig): OmniClawConfig {
...
export function applyKimiCodeProviderConfig(cfg: OmniClawConfig): OmniClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: OmniClawConfig): OmniClawConfig {
...
export function applySyntheticProviderConfig(cfg: OmniClawConfig): OmniClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: OmniClawConfig): OmniClawConfig {
...
export function applyXiaomiProviderConfig(cfg: OmniClawConfig): OmniClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: OmniClawConfig): OmniClawConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: OmniClawConfig): OmniClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: OmniClawConfig): OmniClawConfig {
