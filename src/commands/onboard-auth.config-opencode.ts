...
export function applyOpencodeZenProviderConfig(cfg: OmniClawConfig): OmniClawConfig {
...
export function applyOpencodeZenConfig(cfg: OmniClawConfig): OmniClawConfig {
