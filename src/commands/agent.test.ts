...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "omniclaw-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<OmniClawConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<OmniClawConfig["telegram"]>>,
