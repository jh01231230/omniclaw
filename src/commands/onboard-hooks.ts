...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.omniclaw.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("omniclaw hooks list")}`,
      `  ${formatCliCommand("omniclaw hooks enable <name>")}`,
      `  ${formatCliCommand("omniclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
