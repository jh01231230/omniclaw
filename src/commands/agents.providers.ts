...
function resolveDefaultAccountId(cfg: OmniClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OmniClawConfig): boolean {
...
export function summarizeBindings(cfg: OmniClawConfig, bindings: AgentBinding[]): string[] {
