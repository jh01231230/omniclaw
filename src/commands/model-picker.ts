...
function resolveConfiguredModelRaw(cfg: OmniClawConfig): string {
...
function resolveConfiguredModelKeys(cfg: OmniClawConfig): string[] {
...
export function applyPrimaryModel(cfg: OmniClawConfig, model: string): OmniClawConfig {
...
export function applyModelAllowlist(cfg: OmniClawConfig, models: string[]): OmniClawConfig {
  const defaults = cfg.agents?.defaults;
