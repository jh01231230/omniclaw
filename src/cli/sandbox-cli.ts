...
const SANDBOX_EXAMPLES = {
  main: [
    ["omniclaw sandbox list", "List all sandbox containers."],
    ["omniclaw sandbox list --browser", "List only browser containers."],
    ["omniclaw sandbox recreate --all", "Recreate all containers."],
    ["omniclaw sandbox recreate --session main", "Recreate a specific session."],
    ["omniclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["omniclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["omniclaw sandbox list", "List all sandbox containers."],
    ["omniclaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["omniclaw sandbox recreate --all", "Recreate all containers."],
    ["omniclaw sandbox recreate --session main", "Recreate a specific session."],
    ["omniclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["omniclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["omniclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["omniclaw sandbox explain", "Show effective sandbox config."],
    ["omniclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["omniclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["omniclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.omniclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
