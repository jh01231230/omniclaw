...
import type { GatewayBindMode, GatewayTailscaleMode, OmniClawConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      ["Docs:", "https://docs.omniclaw.ai/gateway/tailscale", "https://docs.omniclaw.ai/web"].join(
        "\n",
      ),
      "Tailscale",
    );
