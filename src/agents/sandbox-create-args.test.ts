  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "omniclaw.sandbox=1",
        "--label",
        "omniclaw.sessionKey=main",
        "--label",
        "omniclaw.createdAtMs=1700000000000",
        "--label",
        "omniclaw.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
