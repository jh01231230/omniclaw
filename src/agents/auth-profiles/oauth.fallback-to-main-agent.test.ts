...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveOmniClawAgentDir() returns mainAgentDir
    process.env.OMNICLAW_STATE_DIR = tmpDir;
    process.env.OMNICLAW_AGENT_DIR = mainAgentDir;
