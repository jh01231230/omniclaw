...
function resolveAvatarSource(cfg: OmniClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OmniClawConfig, agentId: string): AgentAvatarResolution {
