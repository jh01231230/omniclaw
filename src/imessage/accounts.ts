...
export function listIMessageAccountIds(cfg: OmniClawConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: OmniClawConfig): string {
...
function mergeIMessageAccountConfig(cfg: OmniClawConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: OmniClawConfig): ResolvedIMessageAccount[] {
