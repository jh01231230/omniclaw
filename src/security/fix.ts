...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof OmniClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: OmniClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: OmniClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
