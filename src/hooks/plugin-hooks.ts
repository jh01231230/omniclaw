...
import type { OmniClawPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: OmniClawPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: OmniClawPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
