...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: OmniClawConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: OmniClawConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: OmniClawConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: OmniClawConfig): void {
