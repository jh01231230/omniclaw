...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "omniclaw-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveOmniClawPackageRoot } = await import("./omniclaw-root.js");
    ...
    vi.mocked(resolveOmniClawPackageRoot).mockResolvedValue("/opt/omniclaw");
