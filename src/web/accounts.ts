...
export function listWhatsAppAuthDirs(cfg: OmniClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: OmniClawConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: OmniClawConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: OmniClawConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: OmniClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: OmniClawConfig): ResolvedWhatsAppAccount[] {
