...
export type ChannelAgentToolFactory = (params: { cfg?: OmniClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: OmniClawConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: OmniClawConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: OmniClawConfig }) => boolean;
  supportsCards?: (params: { cfg: OmniClawConfig }) => boolean;
