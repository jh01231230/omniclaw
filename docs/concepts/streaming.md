...
OmniClaw has two separate “streaming” layers:
...
When block streaming is enabled, OmniClaw can **merge consecutive block chunks**
...
When draft streaming is active, OmniClaw disables block streaming for that reply to avoid double-streaming.
