---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with OmniClaw"
read_when:
  - You want Xiaomi MiMo models in OmniClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). OmniClaw uses
