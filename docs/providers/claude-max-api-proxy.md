...
You can point OmniClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or OmniClaw
...
- [Anthropic provider](/providers/anthropic) - Native OmniClaw integration with Claude setup-token or API keys
