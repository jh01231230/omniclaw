---
summary: "Use Synthetic's Anthropic-compatible API in OmniClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. OmniClaw registers it as the
...
Note: OmniClaw's Anthropic client appends `/v1` to the base URL, so use
