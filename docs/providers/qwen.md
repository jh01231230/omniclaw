---
summary: "Use Qwen OAuth (free tier) in OmniClaw"
read_when:
  - You want to use Qwen with OmniClaw
...
If you already logged in with the Qwen Code CLI, OmniClaw will sync credentials
