...
read_when:
  - You are building a OmniClaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (omniclaw.plugin.json)

Every plugin **must** ship a `omniclaw.plugin.json` file in the **plugin root**.
OmniClaw uses this manifest to validate configuration **without executing plugin
