...
read_when:
  - You want OmniClaw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables OmniClaw to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`omniclaw onboard`) and `omniclaw channels add` list optional channel plugins.
...
```bash
omniclaw plugins install @omniclaw/nostr
```

Use a local checkout (dev workflows):

```bash
omniclaw plugins install --link <path-to-omniclaw>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "omniclaw",
        "displayName": "OmniClaw",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "omniclaw@example.com",
        "lud16": "omniclaw@example.com"
      }
    }
  }
}
