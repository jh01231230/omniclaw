...
- Install via CLI: `omniclaw plugins install @omniclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `omniclaw plugins install ./extensions/zalo`
   - From npm (if published): `omniclaw plugins install @omniclaw/zalo`
...
- Approve via:
  - `omniclaw pairing list zalo`
  - `omniclaw pairing approve zalo <CODE>`
...
- Example: `omniclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `omniclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `omniclaw logs --follow`
