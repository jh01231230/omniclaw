...
OmniClaw treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.omniclaw/settings/voicewake.json`

Shape:

```json
{ "triggers": ["omniclaw", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
