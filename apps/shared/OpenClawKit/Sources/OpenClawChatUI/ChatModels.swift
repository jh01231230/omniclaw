...
public typealias OmniClawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias OmniClawPlatformImage = UIImage
#endif

public struct OmniClawChatUsageCost: Codable, Hashable, Sendable {
...
public struct OmniClawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: OmniClawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(OmniClawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct OmniClawChatMessageContent: Codable, Hashable, Sendable {
...
public struct OmniClawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [OmniClawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: OmniClawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [OmniClawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: OmniClawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(OmniClawChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([OmniClawChatMessageContent].self, forKey: .content) {
...
public struct OmniClawChatHistoryPayload: Codable, Sendable {
...
public struct OmniClawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct OmniClawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [OmniClawSessionPreviewItem]
}

public struct OmniClawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [OmniClawSessionPreviewEntry]

    public init(ts: Int, previews: [OmniClawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct OmniClawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct OmniClawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct OmniClawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct OmniClawChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct OmniClawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct OmniClawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: OmniClawPlatformImage?
...
public struct OmniClawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
