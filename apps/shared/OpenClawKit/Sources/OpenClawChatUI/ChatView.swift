...
@MainActor
public struct OmniClawChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    public init(
        viewModel: OmniClawChatViewModel,
    ...
    private var visibleMessages: [OmniClawChatMessage] {
        let base: [OmniClawChatMessage]
    ...
    private func mergeToolResults(in messages: [OmniClawChatMessage]) -> [OmniClawChatMessage] {
        ...
        for message in messages {
            ...
            let merged = OmniClawChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: OmniClawChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: OmniClawChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: OmniClawChatMessage) -> String {
