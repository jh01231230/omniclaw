...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = OmniClawChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = OmniClawChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
