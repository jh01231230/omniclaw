...
import "@a2ui/lit/ui";
import { themeContext } from "@omniclaw/a2ui-theme-context";
...
class OmniClawA2UIHost extends LitElement {
  static properties = {
    surfaces: { state: true },
  ...
  static styles = css`
    :host {
      ...
      padding:
        var(--omniclaw-a2ui-inset-top, 0px)
        var(--omniclaw-a2ui-inset-right, 0px)
        var(--omniclaw-a2ui-inset-bottom, 0px)
        var(--omniclaw-a2ui-inset-left, 0px);
    }
    ...
    #surfaces {
      ...
      height: 100%;
      overflow: auto;
      padding-bottom: var(--omniclaw-a2ui-scroll-pad-bottom, 0px);
    }
    ...
    .status {
      ...
      top: var(--omniclaw-a2ui-status-top, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .toast {
      ...
      left: 50%;
      transform: translateX(-50%);
      bottom: var(--omniclaw-a2ui-toast-bottom, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .empty {
      ...
      left: 50%;
      transform: translateX(-50%);
      top: var(--omniclaw-a2ui-empty-top, var(--omniclaw-a2ui-status-top, 12px));
      text-align: center;
      opacity: 0.8;
      padding: 10px 12px;
      pointer-events: none;
  ...
  connectedCallback() {
    ...
    for (const eventName of ["omniclaw:a2ui-action-status"]) {
...
if (!customElements.get("omniclaw-a2ui-host")) {
  customElements.define("omniclaw-a2ui-host", OmniClawA2UIHost);
}
