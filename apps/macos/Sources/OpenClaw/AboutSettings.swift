...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/omniclaw/omniclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                ...
                AboutLinkRow(icon: "globe", title: "Website", url: "https://omniclaw.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "OmniClawBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "OmniClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "OmniClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OmniClawGitCommit") as? String) ??
            "unknown"
    }
