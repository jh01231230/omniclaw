...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (OmniClaw token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: OmniClawOAuthStore.AnthropicOAuthStatus = OmniClawOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "ai.omniclaw", category: "anthropic-oauth")
...
enum OmniClawOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let openclawOAuthDirEnv = "OMNICLAW_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "OmniClaw OAuth token file not found"
            case .unreadableFile: "OmniClaw OAuth token file not readable"
            case .invalidJSON: "OmniClaw OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in OmniClaw OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "OmniClaw OAuth credentials found"
            }
        }
    }
    ...
    static func oauthDir() -> URL {
        ...
        let preferred = home.appendingPathComponent(".omniclaw", isDirectory: true)
