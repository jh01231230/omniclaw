...
enum UIStrings {
    static let welcomeTitle = "Welcome to OmniClaw"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "omniclaw.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: OmniClawOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: OmniClawChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g omniclaw@\(version)"
    }
