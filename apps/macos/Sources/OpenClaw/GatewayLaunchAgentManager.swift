...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.omniclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".omniclaw/disable-launchagent"
