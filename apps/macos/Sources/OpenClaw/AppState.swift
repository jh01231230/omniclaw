...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = OmniClawConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = OmniClawConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = OmniClawConfigFile.loadDict()
            ...
            OmniClawConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/omniclaw"
        state.remoteCliPath = ""
        return state
    }
}
