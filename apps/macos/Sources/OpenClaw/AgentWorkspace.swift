...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.omniclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return OmniClawConfigFile.defaultWorkspaceURL() }
