...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.omniclaw", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.omniclaw", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [OmniClawChatMessage] = messages.compactMap { item in
