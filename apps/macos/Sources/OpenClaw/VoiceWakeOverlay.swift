...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.omniclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other OmniClaw windows, but below the system’s pop-up menus.
