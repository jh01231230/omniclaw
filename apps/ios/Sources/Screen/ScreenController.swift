...
final class ScreenController {
    ...
    /// Callback invoked when an omniclaw:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = OmniClawKitResources.bundle
...
/// Handles navigation policy to intercept omniclaw:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept omniclaw:// deep links.
        if url.scheme?.lowercased() == "omniclaw" {
