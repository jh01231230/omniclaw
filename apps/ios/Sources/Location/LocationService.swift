...
final class LocationService: NSObject, CLLocationManagerDelegate {
    ...
    func ensureAuthorization(mode: OmniClawLocationMode) async -> CLAuthorizationStatus {
    ...
    func currentLocation(
        params: OmniClawLocationGetParams,
    ...
    private static func accuracyValue(_ accuracy: OmniClawLocationAccuracy) -> CLLocationAccuracy {
        switch accuracy {
        case .coarse:
