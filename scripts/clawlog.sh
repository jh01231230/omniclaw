...
show_usage() {
    cat << EOF
clawlog - OmniClaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View OmniClaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    OmniClaw logs flow through the macOS unified log (subsystem: ai.omniclaw).
