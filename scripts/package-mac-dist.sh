...
# Output:
# - dist/OmniClaw.app
# - dist/OmniClaw-<version>.zip
# - dist/OmniClaw-<version>.dmg
...
APP="$ROOT_DIR/dist/OmniClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/OmniClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/OmniClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/OmniClaw-$VERSION.notary.zip"
