...
Use `discord` to manage messages, reactions, threads, polls, and moderation. You can disable groups via `discord.actions.*` (defaults to enabled, except roles/moderation). The tool uses the bot token configured for OmniClaw.
...
```json
{
  ...
  "guildId": "999",
  "name": "openclaw_wave",
  "description": "OmniClaw waving hello",
  "tags": "👋",
